...
#PI CALIB DATA
#[[620.19140548   0.         277.68702913]
# [  0.         623.62826856 249.69875626]
# [  0.           0.           1.        ]]

#[[-0.35010591,0.37369452,-0.00492338,0.0019333,-0.84182934]]


img = cv2.imread('./imgs/36.jpg')
h,  w = img.shape[:2]
...
x, y, w, h = roi
dst = dst[y:y+h, x:x+w]
cv2.imwrite('calibresultLAPTOPCALIB.png', dst)