...
def run(model: str, camera_id: int, width: int, height: int, num_threads: int,
  ...
  detection_options = processor.DetectionOptions(
      max_results=15, score_threshold=0.3, category_name_allowlist=["bottle","refrigerator","person"])
...
#    if len(detection_result.detections) == 10:
#        i = input("How far from front? (cm)")
#        cv2.imwrite("./{}.jpg".format(int(i)), image)
#        with open("boxes.txt", "a") as bs:
